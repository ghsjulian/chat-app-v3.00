  ...
  const checkValidation = () => {
    ...
    if (isChangingPassword) {
      if (!trimmedOldPassword) {
        ...
        showMessage("Old password must be at least 6 characters", false);
        return false;
    ...
    <div ref={areaRef} className="settings">
      ...
      <div className="area">
        ...
        <div className="row">
          ...
          <button className={user?.isVerified ? "verified" : "not-verified"}>
        ...
        <br />
        <div className="row">
          <button disabled={isSaving} onClick={handleSave} className="save-btn">
            {isSaving && <div className="loader"></div>}
            <span>{isSaving ? "Saving..." : "Save Settings & Apply"}</span>
          </button>
        </div>
        {isDeleteClick && (
          <div className="pop">
            <p>Are you confirm?</p>
            <small>
              The account can't be recovered again if you delete once
            </small>
